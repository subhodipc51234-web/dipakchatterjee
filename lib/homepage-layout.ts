...
//
// Phases is NOT part of this reorderable/toggleable set — it's a
// modular subsection of Features now (see components/phases/PhasesSection.tsx),
// rendered at a fixed position right after the Features/Organizations/
// Posts run, always visible whenever there's at least one phase.
